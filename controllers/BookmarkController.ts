 ...
 *     </li>
 *     <li>DELETE /api/bookmarks to remove all bookmarks
 *     </li>
...
export default class BookmarkController implements BookmarkControllerI{
    ...
    public static getInstance = (app: Express): BookmarkController => {
        if (BookmarkController.bookmarkController === null) {
            ...
            app.delete("/api/bookmarks", BookmarkController.bookmarkController.deleteAllBookmarks);
    ...
    /**
     * Removes all Bookmarks instance from the database
     * @param {Request} req Represents request from client
     * @param {Response} res Represents response to client, including status
     * on whether deleting all Bookmarks were successful or not
     */
